        ...
        <table class="table table-striped table-bordered">
          <thead>
            ...
            <?php
                ...
                <select name="change_pack" class="txtedit" called="<?php echo $packs['pack_name']; ?>" securitycode="<?php echo sha1($config['admin_cookie_hash']); ?>" entry="pack_id" table="main" rowid="<?php echo $row['pack_id']; ?>">
                  <?php
